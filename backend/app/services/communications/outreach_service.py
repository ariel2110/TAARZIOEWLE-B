...
class OutreachService:
    def build_business_message(self, db: Session, business_id: int, draft_site_id: int | None = None, message_template_key: str = 'initial_outreach_v1') -> OutreachMessage | None:
